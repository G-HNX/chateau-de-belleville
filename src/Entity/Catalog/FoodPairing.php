...
use App\Repository\Catalog\FoodPairingRepository;
...
/**
 * Accord mets-vins.
 * Ex: "Fruits de mer", "Viandes rouges", "Apéritif"
 */
#[ORM\Entity(repositoryClass: FoodPairingRepository::class)]
#[ORM\Table(name: 'food_pairing')]
...
class FoodPairing
{
    ...
    #[ORM\ManyToMany(targetEntity: Wine::class, mappedBy: 'foodPairings')]
