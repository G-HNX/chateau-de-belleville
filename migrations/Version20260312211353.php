 ...
 */
final class Version20260312211353 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Ajout colonne trusted_token_version + index performances';
    }

    public function up(Schema $schema): void
    {
        $this->addSql('ALTER TABLE "user" ADD COLUMN trusted_token_version INTEGER NOT NULL DEFAULT 0');
        $this->addSql('CREATE INDEX idx_user_last_login_at ON "user" (last_login_at)');
        $this->addSql('CREATE INDEX idx_review_wine_approved ON review (wine_id, is_approved)');
    }
